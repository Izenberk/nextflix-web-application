// apps/web/presentation/sections/TopRatedRow.tsx
'use client'

import { useState } from 'react'
import type { MovieSummary } from '@/domain/movies'
import { useTopRatedMovies } from '@/data/movies.hooks'
...
export function TopRatedRowSkeleton() {
  return (
    <section className="space-y-2 px-6">
      <h2 className="text-lg md:text-xl font-semibold">Top Rated</h2>
